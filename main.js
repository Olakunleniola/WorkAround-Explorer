...
function updateResults(){
  ...
  const averageSalaryByRole = formatter(getAverageSalaryByRole(role));
  const averageSalaryByCompany = formatter(getAverageSalaryByCompany(company));
  const salary = formatter(getAverageSalaryByRole(role, company));
  const industryAverageSalary = formatter(getIndustryAverageSalary());
